 ...
 */
final class Version20191216032155 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE song ADD loge VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE album ADD loge VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE album DROP loge');
        ...
        $this->addSql('ALTER TABLE song DROP loge');
    }
}
